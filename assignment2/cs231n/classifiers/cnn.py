...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # variable.                                                                #
    ############################################################################
    forward1, cache_forward_1 = conv_relu_pool_forward(X, self.params['W1'], self.params['b1'], conv_param, pool_param)

    forward2, cache_forward_2 = affine_forward(forward1, self.params['W2'], self.params['b2'])

    relu2, cache_relu_2 = relu_forward(forward2)

    scores, cache_forward_3 = affine_forward(relu2, self.params['W3'], self.params['b3'])
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
