...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    ############################################################################
    forward1 , cache_forward1 = affine_forward(X, self.params['W1'], self.params['b1'])
    relu1, cache_relu = relu_forward(forward1)
    scores, cache_forward2 = affine_forward(relu1, self.params['W2'], self.params['b2'])
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
